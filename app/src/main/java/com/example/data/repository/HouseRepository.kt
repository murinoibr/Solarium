...
object HouseRepository {
    ...
    val mapLocations: List<MapLocation> = listOf(
        ...
        MapLocation(
            id = "sape",
            title = "Pousada Le Sapê (Ponto de Referência Oficial)",
            category = LocationCategory.HOUSE,
            address = "Rua Pres. Castelo Branco, 20 - Ramon, São Lourenço - MG, CEP 37470-000",
            description = "Ponto de referência oficial do bairro Ramon. A nossa casa fica na primeira quadra imediatamente após a pousada, subindo pela mesma rua à direita no número 95.",
            ...
            tags = listOf("Referência Oficial", "Bairro Ramon", "Ponto de Chegada"),
        ...
        MapLocation(
            ...
            address = "Rua Pres. Castelo Branco (acesso Pousada Le Sapé) - Ramon, São Lourenço - MG",
        ...
        MapLocation(
            id = "padaria_ramon",
            title = "Padaria San Loran (Padaria do Ramon)",
            category = LocationCategory.FOOD,
            address = "Via Ramon, 459 - Ramon, São Lourenço - MG, CEP 37470-000",
            description = "Padaria tradicional do bairro Ramon, pertinho da casa. Pão francês quentinho pela manhã, pão de queijo mineiro recém-saído do forno, bolos caseiros, leite e conveniência matinal.",
            tip = "Dá para ir a pé pela manhã (apenas 7 minutinhos de caminhada) para montar a mesa do café na varanda.",
            latitude = -22.103500,
            longitude = -45.052000,
            distanceEstimate = "650 m (~7 min a pé / 2 min de carro)",
            tags = listOf("Padaria do Bairro", "Pão Francês", "Pão de Queijo", "Café da Manhã", "Pertinho"),
            plusCode = "VWWX+55 São Lourenço, MG",
            rating = 4.6f,
            reviewsCount = 380,
            openingHours = "Seg a Sáb das 06:00 às 20:00 • Dom das 06:30 às 13:00",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Padaria+San+Loran+Sao+Lourenco+MG",
            phone = "(35) 3332-5120"
        ),
        MapLocation(
            id = "doces_sao_lourenco",
            title = "Fábrica & Loja Doces São Lourenço",
            category = LocationCategory.FOOD,
            address = "Via Ramon, 684 - Ramon, São Lourenço - MG, CEP 37470-000",
            description = "A mais célebre fábrica e loja de doces tradicionais de São Lourenço, localizada no próprio bairro Ramon. Produção artesanal de doces de leite em compota e em barra, bananadas, goiabadas e frutas cristalizadas.",
            tip = "Fica no nosso bairro! Ótimo para comprar lembrancinhas e caixas de doces típicos da Mantiqueira direto da fábrica com preços excelentes.",
            latitude = -22.100914,
            longitude = -45.051308,
            distanceEstimate = "1,1 km (~3 min de carro ou 12 min a pé)",
            tags = listOf("Fábrica de Doces", "Doce de Leite", "Preço de Fábrica", "Bairro Ramon", "Tradicional"),
            plusCode = "VWXV+JF São Lourenço, MG",
            rating = 4.7f,
            reviewsCount = 2640,
            openingHours = "Seg a Sex 08:45 às 17:30 • Sáb 09:00 às 18:00 • Dom 09:00 às 14:00",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Doces+Sao+Lourenco+Via+Ramon+MG",
            phone = "(35) 3332-1544"
        ),
        MapLocation(
            id = "templo_eubiose",
            ...
            address = "Rua Dep. Whitaker Pereira, 333 - Vila Nova, São Lourenço - MG, CEP 37470-000",
            description = "Monumento arquitetônico sagrado de estilo clássico greco-egípcio, cercado de jardins e obeliscos. São Lourenço é considerada a capital mística e espiritual da Eubiose no planeta.",
            tip = "Fica muito perto da nossa casa no Ramon! Faça a visita guiada aos sábados ou domingos à tarde para conhecer a história e mistérios dos templos.",
            latitude = -22.106086,
            longitude = -45.053882,
            distanceEstimate = "1,1 km (~3 min de carro ou 12 min a pé)",
        ...
        MapLocation(
            ...
            description = "Principal cartão-postal da estância com 400.000 m² de área verde, 9 fontes hidrominerais raras (incluindo a gasosa natural e a rara Vichy), lago com pedalinhos, balneário termal clássico e bosque preservado.",
            tip = "Compre um copinho de vidro nas lojinhas da entrada para degustar todas as fontes. O balneário oferece massagens e banhos relaxantes de imersão mineral.",
            latitude = -22.114367,
            longitude = -45.057264,
        ...
        MapLocation(
            ...
            category = LocationCategory.ATTRACTION,
            address = "Praça João Lage (em frente aos portões do Parque das Águas) - Centro, São Lourenço - MG",
            description = "Animada feira a céu aberto com dezenas de artesãos e produtores locais: doces de compota em tacho de cobre, queijos curados da Mantiqueira, licores, bordados e artesanato regional.",
        ...
        MapLocation(
            id = "teleferico",
            title = "Teleférico de São Lourenço (Estação Base)",
            category = LocationCategory.ATTRACTION,
            address = "Av. Dom Pedro II, 35 - Centro, São Lourenço - MG, CEP 37470-000",
            description = "Tradicional teleférico com cadeirinhas suspensas que partem do centro em frente ao Parque das Águas até o cume do Morro do Cruzeiro. Percurso aéreo de 1.300 metros com visual panorâmico da cidade.",
            tip = "Suba no meio da tarde para aproveitar a vista e o mirante lá no topo, descendo com a brisa do entardecer.",
            latitude = -22.115299,
            longitude = -45.050623,
            distanceEstimate = "1,9 km (~5 min de carro)",
            tags = listOf("Teleférico", "Passeio Aéreo", "Vista Panorâmica", "Cartão Postal"),
            plusCode = "VWMP+VQ São Lourenço, MG",
            rating = 4.6f,
            reviewsCount = 4120,
            openingHours = "Quarta a Domingo das 09:00 às 17:00",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Teleferico+Sao+Lourenco+MG",
            phone = "(35) 3332-5455"
        ),
        MapLocation(
            id = "morro_cruzeiro",
            ...
            category = LocationCategory.ATTRACTION,
            address = "Via Alto do Cruzeiro - São Lourenço - MG, CEP 37470-000",
            description = "Ponto culminante da cidade (1.045m de altitude) com vista de 360° deslumbrante de São Lourenço e da Serra da Mantiqueira, rampa de decolagem de parapente e capelinha histórica.",
            tip = "O pôr do sol lá de cima é espetacular. Você pode subir de teleférico pelo centro ou de carro pela estrada asfaltada.",
            latitude = -22.114515,
            longitude = -45.045402,
            ...
            rating = 4.7f,
            reviewsCount = 3340,
            openingHours = "Mirante aberto 24h",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Mirante+do+Morro+do+Cruzeiro+Sao+Lourenco+MG"
        ),
        MapLocation(
            id = "trem_aguas",
            title = "Estação do Trem das Águas (Maria Fumaça ABPF)",
            category = LocationCategory.ATTRACTION,
            address = "Praça Dr. Ismael de Souza, 9 - Estação, São Lourenço - MG, CEP 37470-000",
            description = "Estação ferroviária inglesa de 1928 de onde parte a locomotiva a vapor histórica até Soledade de Minas, margeando o Rio Verde com violeiros caipiras e degustações a bordo.",
            tip = "Passeios aos sábados e domingos. Compre os bilhetes com antecedência na bilheteria histórica ou online.",
            latitude = -22.116400,
            longitude = -45.054400,
        ...
        MapLocation(
            ...
            title = "Mercado Municipal de São Lourenço (Mercado Produtor)",
            category = LocationCategory.ATTRACTION,
            address = "Rua Dr. Ribeiro da Luz, 329 - Centro, São Lourenço - MG, CEP 37470-000",
            description = "O tradicional Mercado Produtor de São Lourenço. Dezenas de boxes repletos de queijos artesanais da Mantiqueira e Canastra, doces de leite cremosos, cachaças envelhecidas em tonéis de madeira nobre e temperos da roça.",
            tip = "Peça o tradicional pastel de feira com caldo de cana e aproveite as degustações gratuitas de queijos antes de levar.",
            latitude = -22.117250,
            longitude = -45.051800,
            distanceEstimate = "2,0 km (~5 min de carro)",
            tags = listOf("Mercado Produtor", "Queijos Artesanais", "Doces de Leite", "Cachaças", "Pastel de Feira"),
            plusCode = "VWMX+37 São Lourenço, MG",
            rating = 4.7f,
            reviewsCount = 4620,
            openingHours = "Seg a Sáb das 07:00 às 18:30 • Dom das 07:00 às 12:30",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Mercado+Municipal+Sao+Lourenco+MG",
            phone = "(35) 3332-4144"
        ),
        MapLocation(
            id = "basilica_matriz",
            ...
            category = LocationCategory.ATTRACTION,
            address = "Praça Frei Egídio de Assis, 2 - Centro, São Lourenço - MG, CEP 37470-000",
            description = "Imponente igreja central elevada pelo Vaticano ao status de Basílica Menor. Destaca-se por vitrais europeus de rara beleza, mosaicos artísticos e relíquia sagrada de São Lourenço Mártir.",
            tip = "Local de paz e contemplação no centro histórico. A praça adjacente tem belos jardins floridos e bancos à sombra.",
            latitude = -22.115932,
            longitude = -45.054691,
            distanceEstimate = "1,9 km (~5 min de carro)",
        ...
        MapLocation(
            ...
            description = "Fazenda típica mineira com tradicional almoço no fogão a lenha, premiada queijaria artesanal, doces da fazenda e animais para interação familiar.",
        ...
        MapLocation(
            ...
            category = LocationCategory.FOOD,
            address = "Rua Wenceslau Braz, 35 - Centro, São Lourenço - MG, CEP 37470-000",
            description = "Cafeteria boutique eleita entre as melhores do Brasil. Grãos premiados de microlotes da Mantiqueira, métodos manuais de extração (V60, Chemex, Aeropress, Prensa Francesa), waffles belgas e doces artesanais.",
        ...
        MapLocation(
            ...
            category = LocationCategory.ATTRACTION,
            address = "Via Othon de Carvalho, 1020 - Vale dos Pinheiros, São Lourenço - MG, CEP 37470-000",
            description = "Espaço sensorial dedicado aos cafés especiais da Mantiqueira de Minas com denominação de origem protegida. Torrefação ao vivo, estufas e laboratório de degustação cupping.",
            tip = "Agende a experiência guiada para aprender a identificar notas florais, frutadas e de caramelo dos cafés de altitude.",
            latitude = -22.126400,
            longitude = -45.059400,
        ...
        MapLocation(
            id = "laticinios_miramar",
            title = "Laticínios Miramar (Queijos & Doces Nobres)",
            category = LocationCategory.FOOD,
            address = "Av. Daniel de Carvalho, 22 - Centro / Estação, São Lourenço - MG, CEP 37470-000",
            description = "Uma das lojas de queijos e iguarias mineiras mais tradicionais e conceituadas da região. Grande variedade de queijos Mantiqueira de Minas premiados, manteigas da roça, doces artesanais e vinhos.",
            tip = "Fica pertinho da Estação do Trem das Águas e possui estacionamento privativo. Prove o queijo Mantiqueira curado e o doce de leite especial.",
            latitude = -22.116650,
            longitude = -45.054100,
            distanceEstimate = "2,0 km (~5 min de carro)",
            tags = listOf("Laticínios", "Queijos Premiados", "Mantiqueira", "Doce de Leite", "Estacionamento"),
            plusCode = "VWMP+89 São Lourenço, MG",
            rating = 4.8f,
            reviewsCount = 3100,
            openingHours = "Seg a Sáb das 08:00 às 19:00 • Dom das 08:30 às 14:00",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Laticinios+Miramar+Sao+Lourenco+MG",
            phone = "(35) 3332-1600"
        ),
        MapLocation(
            ...
            category = LocationCategory.FOOD,
            address = "Av. Comendador Costa, 669 - Centro, São Lourenço - MG, CEP 37470-000",
            description = "Gastrobar e cervejaria artesanal de São Lourenço. Produz chopp fresco em diversos estilos (IPA, Weiss, American Pale Ale, Red Ale e Stout), acompanhado de hambúrgueres na brasa e música ao vivo.",
        ...
        MapLocation(
            ...
            category = LocationCategory.FOOD,
            address = "Av. Comendador Costa, 603 - Centro, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            ...
            category = LocationCategory.FOOD,
            address = "Av. Comendador Costa, 405 - Centro, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            ...
            category = LocationCategory.FOOD,
            address = "Av. Dr. Getúlio Vargas, 1660 - Vila Carneiro, São Lourenço - MG, CEP 37470-000",
            description = "Clássico boteco tradicional mineiro com cerveja estupidamente gelada, cachaças regionais e os melhores petiscos clássicos de balcão de São Lourenço.",
        ...
        MapLocation(
            ...
            category = LocationCategory.FOOD,
            address = "Av. Comendador Costa, 717 - Centro, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            ...
            category = LocationCategory.FOOD,
            address = "Av. Dom Pedro II, 540 - Centro, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            ...
            category = LocationCategory.FOOD,
            address = "Rua Wenceslau Braz, Centro, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            ...
            category = LocationCategory.SERVICES,
            address = "Av. Dom Pedro II, 780 - Centro, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            id = "posto_san_remo",
            title = "Posto San Remo 24h & Eletroposto (EcoCharge)",
            category = LocationCategory.SERVICES,
            address = "Av. Dom Pedro II, 668 - Centro, São Lourenço - MG, CEP 37470-000",
            description = "Posto de combustível com bandeira de confiança, aberto 24 horas, loja de conveniência, calibrador de pneus e estação de recarga para carros elétricos (EcoCharge).",
            tip = "Melhor opção no centro para abastecer na chegada ou antes de pegar a estrada de volta.",
            latitude = -22.116900,
            longitude = -45.053100,
            distanceEstimate = "2,0 km (~5 min de carro)",
            tags = listOf("Posto 24 Horas", "Combustível", "Carregador Elétrico", "Conveniência"),
            plusCode = "VWMQ+PQ São Lourenço, MG",
            rating = 4.5f,
            reviewsCount = 1420,
            openingHours = "Aberto 24 Horas",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Posto+San+Remo+Sao+Lourenco+MG",
            phone = "(35) 3332-1200"
        ),
        MapLocation(
        ...
        MapLocation(
            ...
            category = LocationCategory.EMERGENCY,
            address = "Rua Jaime Sotto Mayor, 345 - Federal, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            ...
            category = LocationCategory.EMERGENCY,
            address = "Av. Damião Junqueira de Souza, s/n - Federal, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            ...
            category = LocationCategory.EMERGENCY,
            address = "Praça Dr. Humberto Sanches, 10 - Centro, São Lourenço - MG, CEP 37470-000",
            ...
            tip = "São Lourenço é conhecida pelo ambiente seguro e acolhedor. Para atendimento ou apoio policial, disque 190.",
            latitude = -22.116800,
            longitude = -45.053200,
            distanceEstimate = "2,0 km (~5 min de carro)",
        ...
        MapLocation(
            id = "drogaria_raia",
            title = "Drogaria Raia (Farmácia Central)",
            category = LocationCategory.EMERGENCY,
            address = "Av. Dom Pedro II, 450 - Centro, São Lourenço - MG, CEP 37470-000",
            ...
            tip = "Fica na avenida principal do centro perto do Parque das Águas.",
            latitude = -22.116500,
            longitude = -45.053900,
            distanceEstimate = "1,9 km (~5 min de carro)",
            ...
            rating = 4.5f,
            reviewsCount = 390,
            openingHours = "Seg a Dom 07:00 às 23:00 (com plantão noturno rotativo)",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Drogaria+Raia+Sao+Lourenco+MG",
            phone = "(35) 3332-1050"
        ),
        MapLocation(
            id = "drogaria_pacheco",
            title = "Drogarias Pacheco (Farmácia Centro)",
            category = LocationCategory.EMERGENCY,
            address = "Av. Dom Pedro II, 535 - Centro, São Lourenço - MG, CEP 37470-000",
            description = "Rede de farmácias completa com medicamentos, linha dermatológica, primeiros socorros e atendimento farmacêutico no coração do centro comercial.",
            tip = "Fica na mesma avenida da Drogaria Raia, facilitando encontrar remédios de urgência.",
            latitude = -22.116300,
            longitude = -45.053700,
            distanceEstimate = "1,9 km (~5 min de carro)",
            tags = listOf("Farmácia", "Medicamentos", "Primeiros Socorros", "Centro"),
            plusCode = "VWMQ+G8 São Lourenço, MG",
            rating = 4.4f,
            reviewsCount = 520,
            openingHours = "Diariamente das 07:00 às 23:00",
            googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Drogarias+Pacheco+Sao+Lourenco+MG",
            phone = "(35) 3332-6100"
        ),
        MapLocation(
            id = "rodoviaria",
            ...
            category = LocationCategory.TRANSPORT,
            address = "Av. Damião Junqueira de Souza, 900 - Federal, São Lourenço - MG, CEP 37470-000",
        ...
        MapLocation(
            ...
            category = LocationCategory.ATTRACTION,
            address = "Campos de Decolagem - Rodovia São Lourenço / Soledade - São Lourenço - MG",
