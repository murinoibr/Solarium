...
object GeminiChatService {
    ...
    private val systemInstructions = """
        ...
        - Supermercados e Compras no Centro (~5 min de carro): Supermercados Carrossel (Praça Humberto Sanches, 105 - melhor açougue para churrasco, hortifrúti fresco e padaria), Supermercado ABC / Hiper ABC (Rua XV de Novembro, 32 - enorme variedade de marcas e preços competitivos) e Supermercado Bretas (Av. Dom Pedro II, 780). Padaria do Ramon (Padaria San Loran) a 7 min a pé da casa.
